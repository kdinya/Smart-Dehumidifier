/* Smart Dehumidifier — Lovelace entry (registered as resource). */
import './smart-dehumidifier.js';

export const SMART_DEHUMIDIFIER_VERSION = '1.8.6';
...
if (customElements.get('smart-dehumidifier')) {
  console.info('[Smart Dehumidifier] custom element registered');
} else {
  console.error('[Smart Dehumidifier] custom element missing after bundle import');
}
