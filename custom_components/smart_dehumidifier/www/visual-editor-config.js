...
export const EDITOR_SCHEMA = [
  ...
  section('auto_ui', '🪄', 'Автовологість', [
    tog('show_auto_ui', 'Показати панель Auto', true),
    txt('auto_ui_icon', 'Іконка панелі Auto', 'mdi:water-percent'),
    txt('auto_ui_label_text', 'Текст панелі Auto', 'Авто'),
    num('auto_ui_icon_size', 'Розмір іконки', 6, 60, 18, 1),
    num('auto_ui_label_size', 'Розмір тексту', 6, 40, 13, 1),
    num('auto_ui_value_size', 'Розмір вологості', 6, 40, 15, 1),
