import { html, css, LitElement } from './files/lit-proxy.js?v=1.8.3';
import { EDITOR_SCHEMA, ENTITY_FIELDS } from './visual-editor-config.js?v=1.8.3';
import { t, getLang } from './i18n.js?v=1.8.3';
